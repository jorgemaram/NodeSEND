      ...
      <div className="md:w-4/5 xl:w-3/5 mx-auto mb-32">
        {url ? (
          <>
            ...
            <button type="button" className="bg-red-500 hover:bg-gray-900 w-full p-2 text-white uppercase font-bold mt-10" onClick={() => navigator.clipboard.writeText(`${process.env.frontendURL}/enlaces/${url}`)}>Copiar enlace</button>
          </>
        ) : (
          <>
            ...
            <div className="lg:flex md:shadow-lg p-5 bg-white rounded-lg py-10">
              ...
              <div className="md:flex-1 mb-3 mx-2 mt-16 lg:mt-0">
                ...
                <Link href='/crearcuenta'>
                  <a className='text-red-500 font-bold text-lg hover:text-red-700'>Crea una cuenta para obtener mayores ventajas</a>
                </Link>
              </div>
            </div>
          </>
